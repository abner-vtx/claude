...
.app-header{background:linear-gradient(135deg,#0072B2 0%,#56B4E9 100%);padding:14px 24px;display:flex;align-items:center;gap:16px;box-shadow:0 2px 10px rgba(0,114,178,.2);position:sticky;top:0;z-index:100;}
.app-header .logo{height:46px;width:46px;background:rgba(255,255,255,.15);border-radius:8px;display:flex;align-items:center;justify-content:center;color:#fff;flex-shrink:0;}
.app-header h1{color:#fff;font-size:1.5rem;letter-spacing:.5px;}
...
/* tabs */
.tabs{background:#fff;border-bottom:2px solid var(--blue);box-shadow:0 2px 5px rgba(0,0,0,.05);position:sticky;top:74px;z-index:90;}
.tabs-wrap{max-width:1400px;margin:0 auto;display:flex;overflow-x:auto;padding:0 24px;}
.tab-btn{padding:16px 22px;border:none;background:none;cursor:pointer;font-size:15px;font-weight:500;color:#666;border-bottom:3px solid transparent;transition:all .25s;white-space:nowrap;font-family:inherit;display:flex;align-items:center;gap:8px;}
...
.metrics-row{display:grid;grid-template-columns:repeat(auto-fit,minmax(160px,1fr));gap:20px;margin-bottom:28px;}
.metric-card{background:#fff;border:1px solid var(--border);border-left:4px solid var(--blue);border-radius:8px;padding:20px;transition:box-shadow .2s;}
.metric-card:hover{box-shadow:0 4px 12px rgba(0,0,0,.08);}
.metric-card.green{border-left-color:var(--green);} .metric-card.amber{border-left-color:var(--gold);} .metric-card.red{border-left-color:#DC2626;}
.metric-val{font-size:32px;font-weight:700;line-height:1;margin-bottom:4px;color:var(--text);}
.metric-card.green .metric-val{color:var(--green);} .metric-card.amber .metric-val{color:var(--amber);} .metric-card.red .metric-val{color:var(--red);}
...
.notif-pill{background:#fff;border:1px solid #FDE68A;border-radius:20px;padding:4px 11px;font-size:12px;color:var(--amber);cursor:pointer;}
.notif-pill:hover{background:#FFFBEB;}
...
<svg width="0" height="0" style="position:absolute" aria-hidden="true">
 <symbol id="i-flask" viewBox="0 0 24 24"><path fill="none" stroke="currentColor" stroke-width="1.7" stroke-linecap="round" stroke-linejoin="round" d="M9 3h6M10 3v6l-5 8a2 2 0 0 0 2 3h10a2 2 0 0 0 2-3l-5-8V3M7 14h10"/></symbol>
 <symbol id="i-gauge" viewBox="0 0 24 24"><path fill="none" stroke="currentColor" stroke-width="1.7" stroke-linecap="round" stroke-linejoin="round" d="M12 13l4-3M4 18a8 8 0 1 1 16 0z"/></symbol>
 <symbol id="i-doc" viewBox="0 0 24 24"><path fill="none" stroke="currentColor" stroke-width="1.7" stroke-linecap="round" stroke-linejoin="round" d="M14 3H7a2 2 0 0 0-2 2v14a2 2 0 0 0 2 2h10a2 2 0 0 0 2-2V8zM14 3v5h5M9 13h6M9 17h6"/></symbol>
 <symbol id="i-compass" viewBox="0 0 24 24"><path fill="none" stroke="currentColor" stroke-width="1.7" stroke-linecap="round" stroke-linejoin="round" d="M12 22a10 10 0 1 0 0-20 10 10 0 0 0 0 20zM16 8l-2 6-6 2 2-6z"/></symbol>
 <symbol id="i-warn" viewBox="0 0 24 24"><path fill="none" stroke="currentColor" stroke-width="1.7" stroke-linecap="round" stroke-linejoin="round" d="M12 9v4M12 17h.01M10.3 3.9 2 18a2 2 0 0 0 1.7 3h16.6a2 2 0 0 0 1.7-3L13.7 3.9a2 2 0 0 0-3.4 0z"/></symbol>
 ...
 <symbol id="i-scale" viewBox="0 0 24 24"><path fill="none" stroke="currentColor" stroke-width="1.6" stroke-linecap="round" stroke-linejoin="round" d="M12 3v18M7 21h10M5 7h14M5 7l-3 6a3 3 0 0 0 6 0zM19 7l-3 6a3 3 0 0 0 6 0z"/></symbol>
 <symbol id="i-box" viewBox="0 0 24 24"><path fill="none" stroke="currentColor" stroke-width="1.6" stroke-linecap="round" stroke-linejoin="round" d="M21 8l-9-5-9 5 9 5 9-5zM3 8v8l9 5 9-5V8M12 13v8"/></symbol>
 <symbol id="i-chat" viewBox="0 0 24 24"><path fill="none" stroke="currentColor" stroke-width="1.6" stroke-linecap="round" stroke-linejoin="round" d="M21 12a8 8 0 0 1-11.5 7.2L3 21l1.8-6.5A8 8 0 1 1 21 12z"/></symbol>
 <symbol id="i-drop" viewBox="0 0 24 24"><path fill="none" stroke="currentColor" stroke-width="1.6" stroke-linecap="round" stroke-linejoin="round" d="M12 3s6 6.5 6 11a6 6 0 0 1-12 0c0-4.5 6-11 6-11z"/></symbol>
 <symbol id="i-flow" viewBox="0 0 24 24"><path fill="none" stroke="currentColor" stroke-width="1.7" stroke-linecap="round" stroke-linejoin="round" d="M4 5h6v4H4zM14 15h6v4h-6zM7 9v3a2 2 0 0 0 2 2h8"/></symbol>
</svg>

<header class="app-header">
 <div class="logo"><svg width="26" height="26"><use href="#i-flask"/></svg></div>
 <div><h1>Vertex Analytical Labs</h1><p>Quality Management System Platform &mdash; ISO/IEC 17025:2017</p></div>
 <div class="spacer"></div>
 <div class="who"><div class="name">Ivan Gonzalez</div><div class="role">Laboratory Manager</div></div>
 <div class="avatar">IG</div>
</header>

<nav class="tabs">
 <div class="tabs-wrap" role="tablist">
  <button class="tab-btn active" data-tab="dashboard"><svg width="17" height="17"><use href="#i-gauge"/></svg> Dashboard</button>
  <button class="tab-btn" data-tab="docs"><svg width="17" height="17"><use href="#i-doc"/></svg> Document Control</button>
  <button class="tab-btn" data-tab="ops"><svg width="17" height="17"><use href="#i-warn"/></svg> Quality Operations</button>
  <button class="tab-btn" data-tab="compass"><svg width="17" height="17"><use href="#i-compass"/></svg> Lab Compass</button>
 </div>
</nav>
...
<main>
 ...
 <section id="v-dashboard" class="view active">
  ...
  <div class="notif-banner">
   <svg width="20" height="20" style="color:var(--gold);flex-shrink:0"><use href="#i-warn"/></svg>
  ...
  <div class="grid-2">
   <div class="card"><div class="card-hd"><h3><svg width="18" height="18"><use href="#i-doc"/></svg> Compliance Statement</h3></div><div class="card-bd"><div class="compliance-stmt" id="complianceStmt"></div></div></div>
   <div>
    <div class="card"><div class="card-hd"><h3><svg width="18" height="18"><use href="#i-flow"/></svg> Management Review</h3></div><div class="card-bd">
    ...
    <div class="card" style="margin-bottom:0"><div class="card-hd"><h3>Recent Activity</h3></div><div class="card-bd" id="activityFeed"></div></div>
   </div>
  </div>
 </section>
 ...
 <section id="v-docs" class="view">
  ...
  <div id="s-dcr" class="subview">
   <div class="card"><div class="card-hd"><h3>Document Change Requests</h3><button class="btn btn-primary btn-sm" onclick="openModal('m-dcr')"><svg width="14" height="14"><use href="#i-plus"/></svg> New Request</button></div>
...
var OPS_META={
 ...
 ofi:{list:'ofi',h:['OFI #','Idea','Status','_','Date'],title:'Improvement',clause:'8.6',btn:'Submit OFI'},
...
function renderDashboard(){
 ...
 var kpis=[
  {v:sops,l:'Procedures',sub:'Controlled SOPs',c:''},
  {v:'86',l:'Forms & Records',sub:'Quality records',c:''},
  {v:(clauses+2)+' / 20',l:'ISO Clause Areas',sub:'17025 addressed',c:'green'},
  {v:procs,l:'Process Steps',sub:'Documented',c:''},
  {v:SP.items('ncw').length,l:'Open NCW',sub:'Nonconformances',c:'red'},
  {v:SP.items('ca').length,l:'Open CAPAs',sub:'Corrective actions',c:'amber'},
  {v:'1',l:'Pending DCRs',sub:'Change requests',c:'amber'},
  {v:'May 2026',l:'Next Assessment',sub:'Surveillance',c:'green'}
 ];
 byId('kpiRow').innerHTML=kpis.map(function(k){return '<div class="metric-card '+k.c+'"><div class="metric-val">'+esc(k.v)+'</div><div class="metric-lbl">'+esc(k.l)+'</div><div class="metric-sub">'+esc(k.sub)+'</div></div>';}).join('');
...
function showSop(sid){
 ...
 html+='<div class="doc-viewer"><svg width="26" height="26" style="color:#94A3B8"><use href="#i-doc"/></svg><div style="margin-top:6px">Document viewer \u2014 the controlled PDF of '+esc(sid)+' renders here (SharePoint file preview in the built page).</div></div>';
...
function renderOps(){
 Object.keys(OPS_META).forEach(function(k){
  ...
  byId('s-'+k).innerHTML='<div class="card"><div class="card-hd"><h3>'+esc(m.title)+' <span class="mono" style="color:var(--muted);font-weight:400">&middot; Clause '+esc(m.clause)+'</span></h3><button class="btn btn-primary btn-sm" onclick="'+act+'"><svg width="14" height="14"><use href=\"#i-plus\"/></svg> '+esc(m.btn)+'</button></div><div class="card-bd"><table><thead><tr>'+head+'</tr></thead><tbody>'+body+'</tbody></table></div></div>';
 });
}
