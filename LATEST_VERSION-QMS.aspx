...
<div class="modal-backdrop" id="m-cmp">
 <div class="modal">
  ...
  <div class="modal-body">
   ...
   <div class="form-grid">
    <div class="form-group"><label>Category <span class="req">*</span></label><select class="form-input" name="Category"><option>Complaint</option><option>Feedback</option></select></div>
    <div class="form-group"><label>Received Through <span class="req">*</span></label><select class="form-input" name="ReceivedThrough"><option>Phone</option><option>Email</option><option>Letter</option><option>Website</option><option>In-Person</option></select></div>
   </div>
   <div class="form-group span-2"><label>Company <span class="req">*</span></label><input class="form-input" name="SubmitterCompany" placeholder="Submitter company"></div>
   <div class="form-group span-2"><label>Description <span class="req">*</span></label><textarea class="form-input" name="Description" placeholder="Record the complaint exactly as received"></textarea></div>
  ...
  <div class="modal-footer"><button class="btn btn-outline" onclick="closeModal('m-cmp')">Cancel</button><button class="btn btn-primary" onclick="saveComplaint()">Save</button></div>
 </div>
</div>
...
<!-- Nonconforming Work modal -->
<div class="modal-backdrop" id="m-ncw">
 <div class="modal">
  <div class="modal-header"><div><h2>Log Nonconforming Work</h2><p>LS_QP1301r01 &middot; Clause 7.10</p></div><button class="modal-close" onclick="closeModal('m-ncw')">&times;</button></div>
  <div class="modal-body">
   <div class="section-title">Section 01 &mdash; Reporting</div>
   <div class="form-grid">
    <div class="form-group"><label>Reported By <span class="req">*</span></label><input class="form-input" name="ReportedBy" placeholder="Auto-populated (current user)" readonly></div>
    <div class="form-group"><label>Date <span class="req">*</span></label><input class="form-input" name="ReportedDate" type="date"></div>
   </div>
   <div class="form-group"><label>Externally Detected? <span class="req">*</span></label><select class="form-input" name="ExternallyDetected" onchange="document.getElementById('ncw-ext-fields').style.display=this.value==='Yes'?'block':'none'"><option value="No">No</option><option value="Yes">Yes</option></select></div>
   <div id="ncw-ext-fields" style="display:none">
    <div class="form-grid">
     <div class="form-group"><label>External &mdash; Reported By</label><input class="form-input" name="ExtReportedBy" placeholder="Name"></div>
     <div class="form-group"><label>External &mdash; Email</label><input class="form-input" name="ExtReporterEmail" type="email"></div>
     <div class="form-group"><label>External &mdash; Date Reported</label><input class="form-input" name="ExtDateReported" type="date"></div>
     <div class="form-group"><label>External &mdash; Company</label><input class="form-input" name="ExtCompany"></div>
    </div>
   </div>
   ...
   <div class="form-grid">
    ...
    <div class="form-group"><label>Test Report #</label><input class="form-input" name="TestReportNo"></div>
    <div class="form-group"><label>Date NC Occurred <span class="req">*</span></label><input class="form-input" name="OccurredDate" type="date"></div>
   </div>
   <div class="form-group span-2"><label>Description of Nonconforming Work <span class="req">*</span></label><textarea class="form-input" name="Description" placeholder="Full narrative of the nonconformance"></textarea></div>

   <div class="section-title">Section 03 &mdash; Validation</div>
   <div class="form-grid">
    <div class="form-group"><label>Is the information valid and reliable? <span class="req">*</span></label><select class="form-input" name="IsValid"><option>Yes</option><option>No</option></select></div>
    <div class="form-group"><label>Does the NC proceed? <span class="req">*</span></label><select class="form-input" name="Proceeds"><option>Yes</option><option>No</option></select></div>
   </div>
   <div class="form-group span-2"><label>Rationale (from analysis) <span class="req">*</span></label><textarea class="form-input" name="ValidationRationale" placeholder="Justification citing the relevant clause/procedure"></textarea></div>
   <div class="form-group span-2"><label>Impact Assessment (incl. previous services) <span class="req">*</span></label><textarea class="form-input" name="ImpactAssessment" placeholder="Required when the NC proceeds"></textarea></div>
   <div class="form-grid">
    <div class="form-group"><label>Evaluated By <span class="req">*</span></label><input class="form-input" name="EvaluatedBy"></div>
    <div class="form-group"><label>Position <span class="req">*</span></label><input class="form-input" name="EvaluatorPosition"></div>
    <div class="form-group"><label>Date of Evaluation <span class="req">*</span></label><input class="form-input" name="EvaluationDate" type="date"></div>
    <div class="form-group"><label>Notify customer? <span class="req">*</span></label><select class="form-input" name="CustomerNotifyReqEval"><option>No</option><option>Yes</option></select></div>
   </div>

   <div class="section-title">Section 04 &mdash; Immediate Actions, Containment &amp; Resumption</div>
   <div class="form-group span-2"><label>Immediate Actions to Address the NC <span class="req">*</span></label><textarea class="form-input" name="ImmediateActions" placeholder="Numbered containment/correction actions"></textarea></div>
   <div class="form-grid">
    <div class="form-group"><label>Responsible <span class="req">*</span></label><input class="form-input" name="ImmediateResponsible"></div>
    <div class="form-group"><label>Date <span class="req">*</span></label><input class="form-input" name="ImmediateActionDate" type="date"></div>
   </div>
   <div class="form-grid">
    <div class="form-group"><label>Risk Level (7.10.1 b) <span class="req">*</span></label><select class="form-input" name="RiskLevel"><option>Low</option><option selected>Medium</option><option>High</option></select></div>
    <div class="form-group"><label>Was work halted / repeated? <span class="req">*</span></label><select class="form-input" name="WorkHalted"><option>Continued (justified)</option><option>Halted</option><option>Repeated</option></select></div>
   </div>
   <div class="form-grid">
    <div class="form-group"><label>Reports / certificates action (7.10.1 e) <span class="req">*</span></label><select class="form-input" name="ReportsAction"><option>None required</option><option>Reports withheld</option><option>Reports recalled</option><option>Certificates withdrawn</option></select></div>
    <div class="form-group"><label>Authority for Resumption (7.10.1 f)</label><input class="form-input" name="ResumptionAuthorizedBy" placeholder="Required when work was halted"></div>
   </div>

   <div class="section-title">Section 05 &mdash; Corrective Action Decision</div>
   <div class="form-grid">
    <div class="form-group"><label>Is Corrective Action required? <span class="req">*</span></label><select class="form-input" name="CARequired"><option>No</option><option>Yes</option></select></div>
    <div class="form-group"><label>Target Closure Date</label><input class="form-input" name="DueDate" type="date"></div>
   </div>
   <div class="form-group span-2"><label>Rationale (per ISO/IEC 17025:2017 &sect;8.7) <span class="req">*</span></label><textarea class="form-input" name="CARationale" placeholder="Justification for the CA decision"></textarea></div>

   <div class="info-box amber"><strong>Resumption of work (7.10.1 f)</strong>If work was halted, the NCW cannot be closed until an authorized person explicitly releases work to resume. High risk level suggests halting work and reviewing issued reports.</div>
  </div>
  <div class="modal-footer"><button class="btn btn-outline" onclick="closeModal('m-ncw')">Cancel</button><button class="btn btn-primary" onclick="demoSave('m-ncw')">Save NCW</button></div>
 </div>
</div>

<!-- Corrective Action modal -->
<div class="modal-backdrop" id="m-ca">
 <div class="modal">
  <div class="modal-header"><div><h2>Initiate Corrective Action Plan</h2><p>LS_QP1601r01 &middot; Clause 8.7</p></div><button class="modal-close" onclick="closeModal('m-ca')">&times;</button></div>
  <div class="modal-body">
   <div class="section-title">Section 01 &mdash; Problem Statement</div>
   <div class="form-grid">
    <div class="form-group"><label>Recorded By <span class="req">*</span></label><input class="form-input" name="RecordedBy" placeholder="Auto-populated (current user)" readonly></div>
    <div class="form-group"><label>Date <span class="req">*</span></label><input class="form-input" name="RecordedDate" type="date"></div>
   </div>
   <div class="form-group span-2"><label>What went wrong and needs to be corrected? <span class="req">*</span></label><textarea class="form-input" name="ProblemStatement" placeholder="Description of the nonconformity being addressed"></textarea></div>
   <div class="form-grid">
    <div class="form-group"><label>Source <span class="req">*</span></label><select class="form-input" name="SourceType"><option>Nonconforming Work</option><option>Complaint</option><option>Audit Finding</option><option>Management Review</option><option>Other</option></select></div>
    <div class="form-group"><label>Reference Nonconformance</label><input class="form-input" name="ReferenceNC" placeholder="e.g. NC26003"></div>
   </div>
   <div class="form-grid">
   ...
   <div class="section-title">Section 02 &mdash; Extent of Condition (8.7.1 b)</div>
   <div class="form-group"><label>Do similar nonconformities exist or could they occur elsewhere? <span class="req">*</span></label><select class="form-input" name="SimilarNCReviewed"><option>No</option><option>Yes &ndash; found elsewhere</option><option>Yes &ndash; could occur elsewhere</option></select></div>
   <div class="form-group span-2"><label>Extent-of-Condition Findings</label><textarea class="form-input" name="ExtentOfConditionFindings" placeholder="Where did you check (other methods, areas, instruments, time periods) and what was found? Required unless 'No' is selected (with rationale)."></textarea></div>

   <div class="section-title">Section 03 &mdash; Corrective Action Plan</div>
   <div class="form-group span-2"><label>Actions to Correct &amp; Prevent Recurrence <span class="req">*</span></label><textarea class="form-input" name="PlanNarrative" placeholder="Overview of the corrective/preventive strategy"></textarea></div>
   <div class="info-box blue"><strong>Action items</strong>Individual action items with responsible persons, scheduled dates, and verification are tracked in the child list (LS_QP1601r01b_ActionItems) after the CA is created.</div>

   <div class="section-title">Section 04 &mdash; Systemic Follow-through (8.7.1 e &amp; f)</div>
   <div class="form-grid">
    <div class="form-group"><label>Update risks &amp; opportunities? (8.7.1 e) <span class="req">*</span></label><select class="form-input" name="RiskUpdateRequired"><option>No</option><option>Yes</option></select></div>
    <div class="form-group"><label>Make changes to the management system? (8.7.1 f) <span class="req">*</span></label><select class="form-input" name="MSChangeRequired"><option>No</option><option>Yes</option></select></div>
   </div>
   <div class="form-grid">
    <div class="form-group"><label>Notify customer?</label><select class="form-input" name="NotifyCustomer"><option>No</option><option>Yes</option></select></div>
    <div class="form-group"><label>Follow-up audit required?</label><select class="form-input" name="FollowUpAuditReq"><option>No</option><option>Yes</option></select></div>
   </div>
   <div class="form-group"><label>Target Closure Date</label><input class="form-input" name="DueDate" type="date"></div>

   <div class="section-title">Section 05 &mdash; Traceability</div>
   <div class="form-grid">
    <div class="form-group"><label>Related Sample ID</label><input class="form-input" name="RelatedSampleID"></div>
    <div class="form-group"><label>Related Test Report #</label><input class="form-input" name="RelatedTestReport"></div>
    <div class="form-group"><label>Related Equipment</label><input class="form-input" name="RelatedEquipmentID"></div>
    <div class="form-group"><label>Related Method / SOP</label><input class="form-input" name="RelatedMethodSOP"></div>
   </div>

   <div class="info-box amber"><strong>Extent of condition (8.7.1 b)</strong>Check whether this nonconformity exists, or could occur, in other methods, instruments, shifts, or time periods &mdash; not just where it was found. This is one of the most common corrective-action findings.</div>
  </div>
  <div class="modal-footer"><button class="btn btn-outline" onclick="closeModal('m-ca')">Cancel</button><button class="btn btn-primary" onclick="demoSave('m-ca')">Initiate CA</button></div>
 </div>
</div>

<!-- Risks & Opportunities modal -->
<div class="modal-backdrop" id="m-risk">
 <div class="modal">
  <div class="modal-header"><div><h2>Log Risk / Opportunity Action Plan</h2><p>LS_QP1501r01 &middot; Clause 8.5</p></div><button class="modal-close" onclick="closeModal('m-risk')">&times;</button></div>
  <div class="modal-body">
   <div class="section-title">Section 01 &mdash; Initiation</div>
   <div class="form-grid">
    <div class="form-group"><label>Type <span class="req">*</span></label><select class="form-input" name="Type"><option>Risk</option><option>Opportunity</option><option>Improvement</option></select></div>
    <div class="form-group"><label>Initiator <span class="req">*</span></label><input class="form-input" name="Initiator" placeholder="Auto-populated (current user)" readonly></div>
   </div>
   <div class="form-group span-2"><label>Action Plan / Goal <span class="req">*</span></label><textarea class="form-input" name="Goal" placeholder="Statement of what the plan intends to achieve"></textarea></div>
   <div class="form-group span-2"><label>Rationale <span class="req">*</span></label><textarea class="form-input" name="Rationale" placeholder="Why the action is worthwhile / the expected benefit"></textarea></div>
   <div class="form-grid">
    <div class="form-group"><label>Trigger / Source</label><select class="form-input" name="Source"><option>Management Review</option><option>Internal Audit</option><option>Complaint / Feedback</option><option>Nonconforming Work</option><option>Corrective Action</option><option>Change / New Activity</option><option>Staff Proposal</option></select></div>
    <div class="form-group"><label>Source Record</label><input class="form-input" name="SourceRef" placeholder="e.g. AUD-26-01, CMP26002"></div>
   </div>
   <div class="form-grid">
    <div class="form-group"><label>Related Method / SOP</label><input class="form-input" name="RelatedMethodSOP"></div>
    <div class="form-group"><label>Related Equipment</label><input class="form-input" name="RelatedEquipmentID"></div>
   ...
   <div class="section-title">Section 02 &mdash; Impact Assessment</div>
   <div class="info-box blue"><strong>Impact assessment grid</strong>The full eight-dimension impact assessment (Scope &amp; Test Methods, QMS, Personnel, Equipment, Facilities, Business, Regulations, Other) with risk levels and treatment decisions is managed on the child list (LS_QP1501r01a_ImpactAssessment) after the plan is created.</div>
   <div class="form-group"><label>FMEA Risk Assessment</label><input class="form-input" name="FMEARef" placeholder="Link to FE QP15.01 spreadsheet (if applicable)"></div>
   <div class="form-group"><label>Residual Risk After Treatment</label><select class="form-input" name="ResidualRiskLevel"><option></option><option>Low</option><option>Medium</option><option>High</option></select></div>

   <div class="section-title">Section 03 &mdash; Conclusions &amp; Approval</div>
   <div class="form-grid">
    <div class="form-group"><label>Follow-up audit required?</label><select class="form-input" name="FollowUpAuditReq"><option>No</option><option>Yes</option></select></div>
    <div class="form-group"><label>Target Completion Date</label><input class="form-input" name="DueDate" type="date"></div>
   </div>

   <div class="info-box green"><strong>Proportionality (8.5.3)</strong>Actions shall be proportionate to potential impact on the validity of results. High residual risk requires explicit approver acceptance with documented evidence.</div>
  </div>
  <div class="modal-footer"><button class="btn btn-outline" onclick="closeModal('m-risk')">Cancel</button><button class="btn btn-primary" onclick="demoSave('m-risk')">Submit Plan</button></div>
 </div>
</div>

<!-- Audit Notification & Plan modal -->
<div class="modal-backdrop" id="m-audit">
 <div class="modal">
  <div class="modal-header"><div><h2>Schedule Audit &mdash; Notification &amp; Plan</h2><p>LS_QP1701r01 &middot; Clause 8.8</p></div><button class="modal-close" onclick="closeModal('m-audit')">&times;</button></div>
  <div class="modal-body">
   <div class="section-title">Section 01 &mdash; Notification Header</div>
   <div class="form-grid">
    <div class="form-group"><label>Audit Type <span class="req">*</span></label><select class="form-input" name="AuditType"><option>Internal &ndash; Scheduled</option><option>Internal &ndash; Follow-up</option><option>Vendor / External Provider</option></select></div>
    <div class="form-group"><label>Programme Line</label><input class="form-input" name="ProgramLineRef" placeholder="e.g. PM05-2026 line"></div>
   </div>
   <div class="form-grid">
    <div class="form-group"><label>Audit Start Date <span class="req">*</span></label><input class="form-input" name="AuditStartDate" type="date"></div>
    <div class="form-group"><label>Audit End Date <span class="req">*</span></label><input class="form-input" name="AuditEndDate" type="date"></div>
   </div>
   <div class="form-group span-2"><label>Audit Objectives <span class="req">*</span></label><textarea class="form-input" name="Objectives" placeholder="e.g. Verify conformance with ISO/IEC 17025:2017 Clauses 7.1-7.11"></textarea></div>
   <div class="form-group span-2"><label>Scope of the Audit <span class="req">*</span></label><textarea class="form-input" name="Scope" placeholder="Areas, processes, and clause groups to be audited"></textarea></div>
   <div class="form-group span-2"><label>Audit Criteria <span class="req">*</span></label><input class="form-input" name="Criteria" placeholder="e.g. ISO/IEC 17025:2017, Vertex QMS"></div>
   <div class="form-grid">
    <div class="form-group"><label>Audit Team <span class="req">*</span></label><input class="form-input" name="AuditTeam" placeholder="Lead auditor + team members"></div>
    <div class="form-group"><label>Auditee(s)</label><input class="form-input" name="Auditees" placeholder="Personnel being audited"></div>
   </div>

   <div class="section-title">Section 02 &mdash; Independence &amp; Competence (8.8.2)</div>
   <div class="form-group"><label>Auditor Independence <span class="req">*</span></label><select class="form-input" name="AuditorIndependence" onchange="document.getElementById('audit-indep-notes').style.display=this.value==='Conflict noted'?'block':'none'"><option>Confirmed &ndash; auditors do not audit their own work</option><option value="Conflict noted">Conflict noted &ndash; see notes</option></select></div>
   <div id="audit-indep-notes" style="display:none">
    <div class="form-group span-2"><label>Independence Notes</label><textarea class="form-input" name="IndependenceNotes" placeholder="How independence is preserved (e.g. reassignment, second reviewer)"></textarea></div>
   </div>
   <div class="form-group"><label>Auditor Competence Evidence</label><input class="form-input" name="AuditorCompetenceRef" placeholder="Link to training record / FM QP17.04"></div>

   <div class="section-title">Section 03 &mdash; Methodology &amp; Preparation</div>
   <div class="form-group span-2"><label>Audit Methodology <span class="req">*</span></label><textarea class="form-input" name="Methodology" placeholder="Document review, observation, interviews, records/equipment verification"></textarea></div>
   <div class="form-grid">
    <div class="form-group"><label>Prepared By <span class="req">*</span></label><input class="form-input" name="PreparedBy" placeholder="Auto-populated (current user)" readonly></div>
    <div class="form-group"><label>Notification Date <span class="req">*</span></label><input class="form-input" name="NotificationDate" type="date"></div>
   </div>

   <div class="info-box blue"><strong>Auditor independence (8.8.2)</strong>Auditors shall not audit their own work. Independence must be confirmed before the audit can proceed. The day-by-day agenda is managed on the child list (LS_QP1701r01a_AuditAgenda) after the notification is created.</div>
  </div>
  <div class="modal-footer"><button class="btn btn-outline" onclick="closeModal('m-audit')">Cancel</button><button class="btn btn-primary" onclick="demoSave('m-audit')">Create Audit</button></div>
 </div>
</div>

<!-- Seed / fallback list data. Hybrid layer prefers live SharePoint REST when lists have rows; otherwise this blob is used. -->
...
/* ----- Hybrid SharePoint data-access layer -----
...
function statusClass(st){
  ...
  if (/closed|issued|completed|approved|effective|resolved|implemented/.test(st)) return 'b-green';
  if (/escalat|overdue|reject|halt|high|not effective/.test(st)) return 'b-red';
  if (/review|progress|pending|verification|mitigat|draft|new|logged|initiat|under|acknowledged|scheduled|notified/.test(st)) return 'b-amber';
  return 'b-blue';
}
function dateOnly(v){
  if (!v) return '';
...
function mapDocType(dt){
  var s = String(dt || '');
  if (/Quality Manual/i.test(s)) return 'Quality Manual';
  if (/Quality Management Procedure|Quality Procedure|\(QP\)/i.test(s)) return 'Quality Procedure';
  if (/Equipment Use Procedure|Equipment Procedure|\(EP\)/i.test(s)) return 'Equipment Procedure';
  if (/Laboratory Procedure|\(LP\)/i.test(s)) return 'Laboratory Procedure';
  if (/List|Register|Form|Logbook|Electronic Form/i.test(s)) return 'List/Register';
  return s || 'List/Register';
}
...
var SP = {
  items: function(name){ return (CACHE[name] || SEED[name] || []).slice(); },
  source: function(name){ return DATA_SOURCE[name] || 'seed'; },
  ready: function(){ return SP_READY; }
};
...
function formVal(modalId, name){
  var el = byId(modalId).querySelector('[name="'+name+'"]');
  return el ? String(el.value || '').trim() : '';
}
function clearForm(modalId){
  byId(modalId).querySelectorAll('input.form-input, textarea.form-input, select.form-input').forEach(function(el){
    if (el.tagName === 'SELECT') el.selectedIndex = 0;
    else if (el.type !== 'checkbox' && el.type !== 'radio' && !el.readOnly) el.value = '';
  });
}
...
var OPS_META={
 ...
 ncw:{list:'ncw',h:['NC #','Description','Status','_','Date'],title:'Nonconforming Work',clause:'7.10',modal:'m-ncw',btn:'Log NCW'},
 ca:{list:'ca',h:['CAR #','Source / Root cause','Status','_','Date'],title:'Corrective Actions',clause:'8.7',modal:'m-ca',btn:'Initiate CA'},
 risks:{list:'risks',h:['ID','Description','Status','_','Date'],title:'Risks & Opportunities',clause:'8.5',modal:'m-risk',btn:'Log Risk/Opp'},
...
/* Brand icon sprite (SiteAssets/brand-icons.svg, sibling to this page). */
function loadIconSprite(base) {
  if (!base) return;
  fetch(base + '/SiteAssets/brand-icons.svg', { credentials: 'include' })
...
function ptsSiteUrl(){ return PTS_SITE_URL || SP_URL || resolveSiteUrl(); }

function getCurrentUserInfo(){
  var base = SP_URL || resolveSiteUrl();
  if (!base) return Promise.resolve(null);
  return fetch(base + "/_api/web/currentuser?$select=Id,Title", {
    headers: { "Accept": "application/json;odata=nometadata" },
    credentials: "include"
  })
  .then(function(r){ if(!r.ok) throw new Error('currentuser '+r.status); return r.json(); })
  .then(function(d){ return { id:d.Id, name:d.Title }; })
  .catch(function(){ return null; });
}

function getUserPosition(spUserId){
  var base = ptsSiteUrl();
  if (!base || !spUserId) return Promise.resolve('');
  var url = base + "/_api/web/lists/getbytitle('PTS_Users')/items?$filter=SharePointUserId eq " + spUserId + "&$select=Position&$top=1";
  return fetch(url, {
    headers: { "Accept": "application/json;odata=nometadata" },
    credentials: "include"
  })
  .then(function(r){ if(!r.ok) throw new Error('PTS_Users '+r.status); return r.json(); })
  .then(function(j){ var results=j.value||[]; return results.length ? (results[0].Position||"") : ""; })
...
function getRequestDigest() {
  ...
  .then(function(j) { return j.FormDigestValue; });
}
function spGet(path){
...
function nextSequenceId(opts){
  /* opts: { prefix, pad, listKey, field, localRows, extract } */
  var year = yy();
  var prefix = opts.prefix.replace('{YY}', year);
  var pad = opts.pad || 3;
  var re = new RegExp('^' + prefix.replace(/[.*+?^${}()|[\]\\]/g, '\\$&') + '(\\d+)$', 'i');
  function maxFrom(rows, extract){
    var max = 0;
    (rows || []).forEach(function(r){
      var id = extract ? extract(r) : (r.id || '');
      var m = String(id || '').match(re);
      if (m) max = Math.max(max, parseInt(m[1], 10));
    });
    return max;
  }
  var localMax = maxFrom(CACHE[opts.listKey] || SEED[opts.listKey] || [], opts.extract);
  if (!SP_READY || DATA_SOURCE[opts.listKey] !== 'sp') {
    return Promise.resolve(prefix + String(localMax + 1).padStart(pad, '0'));
  }
  var cfg = LIST_MAP[opts.listKey];
  var path = "/_api/web/lists/getbytitle('" + cfg.title.replace(/'/g, "''") + "')/items?$select=" + opts.field + "&$top=5000&$orderby=Id desc";
  return spGetAll(path).then(function(rows){
    var spMax = maxFrom(rows, function(r){ return r[opts.field]; });
    var n = Math.max(localMax, spMax) + 1;
    return prefix + String(n).padStart(pad, '0');
  }).catch(function(){
    return prefix + String(localMax + 1).padStart(pad, '0');
  });
}

function appendLocal(key, row){
  if (!CACHE[key]) CACHE[key] = (SEED[key] || []).slice();
  CACHE[key] = [row].concat(CACHE[key]);
  if (DATA_SOURCE[key] !== 'sp') DATA_SOURCE[key] = 'seed';
}

window.saveComplaint = function(){
  var company = formVal('m-cmp', 'SubmitterCompany');
  var desc = formVal('m-cmp', 'Description');
  var category = formVal('m-cmp', 'Category') || 'Complaint';
  ...
  nextSequenceId({ prefix: 'CMP{YY}', pad: 3, listKey: 'complaints', field: 'RecordID' }).then(function(recordId){
    ...
    var body = {
      ...
      Status: 'New',
      IsValid: 'Yes',
      ValidityRationale: 'Pending evaluation',
      Proceeds: category === 'Feedback' ? 'N/A (Feedback)' : 'Yes',
      EvaluatorPosition: currentUser.position || 'Pending',
      EvaluationDate: today,
      NCWRequired: 'No',
      NCWRationale: 'Pending evaluation'
    };
    if (currentUser.id) {
      body.ReceivedById = currentUser.id;
      body.ValidatedById = currentUser.id;
      body.EvaluatedById = currentUser.id;
    }
    function finish(ok, msg){
      if (btn) { btn.disabled = false; btn.textContent = 'Save'; }
      appendLocal('complaints', uiRow);
      renderOps(); renderDashboard();
      clearForm('m-cmp');
      closeModal('m-cmp');
      showAlert(ok ? 'success' : 'info', msg);
    }
    if (!SP_READY) {
      finish(false, 'Saved locally (seed mode). Open from SharePoint to persist to LS_QP1201r01_Complaints.');
      return;
    }
    var path = "/_api/web/lists/getbytitle('LS_QP1201r01_Complaints')/items";
    return spPost(path, body).then(function(d){
      if (d && d.Id) uiRow._spID = d.Id;
      DATA_SOURCE.complaints = 'sp';
      finish(true, 'Complaint ' + recordId + ' saved to SharePoint.');
    }).catch(function(err){
      console.warn('[QMS] Complaint SP save failed:', err);
      finish(false, 'SharePoint save failed (' + (err.message || err) + '). Kept in session from seed fallback.');
    });
  }).catch(function(err){
    if (btn) { btn.disabled = false; btn.textContent = 'Save'; }
    showAlert('error', 'Could not create complaint ID: ' + (err.message || err));
  });
};
...
window.saveDcr = function(){
  ...
  nextSequenceId({ prefix: 'DCR-{YY}', pad: 3, listKey: 'dcr', field: 'DCRNumber' }).then(function(dcrNumber){
    ...
    var body = {
      ...
      ChangeDriver: driver,
      RequestDate: today,
      ProposedChangeRationale: rationale,
      Stage: 'Draft'
    };
    ...
    if (btn) { btn.disabled = false; btn.textContent = 'Submit Request'; }
    showAlert('error', 'Could not create DCR ID: ' + (err.message || err));
  });
};
...
function renderDashboard(){
 ...
 var pendingDcr=SP.items('dcr').filter(function(r){return !/closed|rejected|issued/i.test(r.stage||'');}).length;
 var kpisBottom=[
  ...
  {v:pendingDcr,l:'Pending DCRs',sub:'Change requests',c:'amber',icon:'icon-edit-outline'},
...
function renderRegister(){
 ...
 byId('registerBody').innerHTML=reg.map(function(n){
  ...
  if (n.status) {
    st = '<span class="badge '+statusClass(n.status)+'">'+esc(n.status)+'</span>';
  }
...
function showSop(sid){
 ...
 if(!n){ byId('sopDetail').innerHTML='<p style="color:var(--muted)">Document not found.</p>'; return; }
...
function renderOps(){
 Object.keys(OPS_META).forEach(function(k){
  ...
  var body=rows.map(function(r){
   var mid=(k==='complaints')?('<td>'+esc(r.c2)+'</td><td><span class="badge '+esc(r.stc)+'">'+esc(r.st)+'</span></td>'):('<td><span class="badge '+esc(r.stc)+'">'+r.c2+'</span></td><td></td>');
...
function renderCompass(){
 ...
 inp.addEventListener('input',function(){
  ...
  ac.querySelectorAll('.ac-item').forEach(function(it){it.addEventListener('click',function(){var n=reg.find(function(x){return x.id===it.dataset.sop;});showGuidance({ti:n?n.title:it.dataset.sop,sops:[it.dataset.sop]});ac.classList.remove('show');inp.value=n?n.title:it.dataset.sop;});});
 });
...
function netClick(ev){
 ...
 if(netSel){var n=reg.find(function(x){return x.id===netSel;});var deg=edges.filter(function(e){return e.s===netSel||e.t===netSel;}).length;byId('netInfo').innerHTML='<strong>'+esc(netSel)+' \u2014 '+esc(n?n.title:'')+'</strong>'+deg+' connection(s). Click the node again to clear.';}
